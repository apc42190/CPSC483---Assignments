...
# Train model
model = linear_model.RidgeCV(alphas = [0, 0.0001, 0.001, 0.1], cv = 10)
...
print(f'alpha: {model.alpha_}, Training Time: {training_time} secs, Testing RMSE: {testing_RMSE}, Training RMSE: {training_RMSE}, Testing R^2: {testing_R_2}, Training R^2: {training_R_2}')
